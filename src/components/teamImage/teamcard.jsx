  ...
  return (
    <>
      <motion.div
        ...
        className="rounded-[18px] p-0.5 bg-gradient-to-b from-[#6CEDFF] to-[#055A98] h-[553px] w-[300px] md:w-[350px] lg:w-[400px] m-4 cursor-pointer hover:shadow-2xl hover:shadow-[#7ac4ec]/30"
      >
