  ...
  return (
    <>
      <NavLink to={route.href}>
        <section className="rounded-[1000px] p-0.5 bg-gradient-to-b from-b_col3 to-b_col4 w-[200px] h-[200px] shadow-2xl shadow-[#7ac4ec]/30 hover:scale-150 transition duration-200 mx-16">
